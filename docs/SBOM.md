...
|---|---|---|---|---|
| faBolusGarmin app | in-repo | MIT | `source/app/` (+ `datafield/`, `watchface/`) | The Monkey C remote: UI, `RemoteComm` transport router, `AppState`, BG complication. Covered by the root `LICENSE`. |
